...
D("capabilities-wholesale", { name: "wrf-estimate-equals-threshold-keeps-granular", comment: "GEN §9.3: two replaces estimate(94) == wholesale-op threshold(94); strict > false, so the granular ops are KEPT", schema: ARR_STR_SCHEMA, capabilities: WRF_IOV, original: { a: ["AAAAAAAAAAA", "CCCCCCCCCCC", "uccccccccccccccccccccccccccccc"] }, modified: { a: ["BBBBBBBBBBB", "DDDDDDDDDDD", "uccccccccccccccccccccccccccccc"] }, roundtrip: "exact" });
D("capabilities-wholesale", { name: "wrf-estimate-exceeds-by-one-goes-wholesale", comment: "GEN §9.3: same shape, the unchanged element 1 byte shorter -> threshold(93) < estimate(94) -> WHOLESALE replace of /a", schema: ARR_STR_SCHEMA, capabilities: WRF_IOV, original: { a: ["AAAAAAAAAAA", "CCCCCCCCCCC", "ucccccccccccccccccccccccccccc"] }, modified: { a: ["BBBBBBBBBBB", "DDDDDDDDDDD", "ucccccccccccccccccccccccccccc"] }, roundtrip: "exact" });
