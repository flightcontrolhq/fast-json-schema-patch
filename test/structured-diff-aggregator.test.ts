...
describe("StructuredDiff", () => {
  ...
  it("should produce correct diffLines", () => {
    ...
    `);
    expect(result.childDiffs["job-scheduler-gWLzaf"]?.diffLines)
  ...
  it("should separate parent and child patches correctly", () => {
    ...
    expect(Object.keys(result.childDiffs).length).toBe(1);
  });

  it("should produce correct diff lines for children", () => {
    const service1Diff = result.childDiffs["job-scheduler-gWLzaf"];
